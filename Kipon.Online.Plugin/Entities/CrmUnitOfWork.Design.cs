...
#warning add full namespace to below
		public static int ToEntityTypeCode(this string value) { return Kipon.Xrm.Extensions.Sdk.KiponSdkGeneratedExtensionMethods.entityLogicalNameToTypeCodeIndex[value]; }
			public static string ToEntityLogicalName(this int value) { return Kipon.Xrm.Extensions.Sdk.KiponSdkGeneratedExtensionMethods.typecodeToEntityLogicalNameIndex[value]; }
	}
	public partial class NamingService
	{
		static NamingService()
		{
#warning  add Kipon.Xrm.Services.NamingService. to add method
