...
The methods are simply looking in the filters after the attribute and operator match, and returns the first found match set of values, regardles of how filters are nested an connected.
