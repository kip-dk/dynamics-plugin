...
The reason for upgrading the version from 1.0.5 to 1.0.5 is the fact that IQueryable<EntityType> injected into a service or a plugin will now be injected as a queryable, that ignore
