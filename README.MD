...
#### Documentation.
Learn how to create plugins with this tool. The documentation page contains a detailed description on what code tocreate and where to put it.
Please follow below link:

[Documentationpage](DODUMENTATION.MD)
