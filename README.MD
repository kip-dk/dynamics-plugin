...
### 1.0.8.1
Issues with statecode, statuscode and optionsset generated in totally new way has been fixed in version 1.0.8.1
...
```shell
Install-Package Kipon.Solid.Plugin -MinimumVersion 1.0.8.1
```
