...
```shell
Install-Package Kipon.Solid.Plugin -MinimumVersion 1.0.1.6
```
...
namespace MySolid.Plugins
{
	public class MySharedPlugin : BasePlugin
	{
		...
		public void OnPreCreate(Entities.IShared target)
		{
			...
			// .. be aware that a typecase of target to the real entity would be a violation of basic SOLID princips - so even though it is possible, it is not the best idear ever. 
		}
	}
}
```
