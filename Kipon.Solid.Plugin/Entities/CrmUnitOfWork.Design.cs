// Plugin Version: 1.0.0.4, Dynamics 365 svcutil solid extension tool by Kipon ApS (c) 2019, Kjeld Poulsen
...
namespace Kipon.Solid.Plugin.Entities
{
   ...
   public class CrmRepository<T> : Kipon.Xrm.IRepository<T> where T: Microsoft.Xrm.Sdk.Entity, new() 
    ...
    public partial class Account
    {
        ...
        public PreferredContactMethodCodeEnum? PreferredContactMethodCode2
        {
            get
            {
                return null;
