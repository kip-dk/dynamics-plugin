// Plugin Version: 1.0.10.14, Dynamics 365 svcutil solid extension tool by Kipon ApS (c) 2019,2020,2021,2022,2023. By Kjeld I. Poulsen
...
namespace Kipon.Xrm
{
	...
	{
		public const string No = "1.0.10.14";
	}
}
namespace Kipon.Solid.Plugin.Entities
{
	...
	public sealed partial class CrmUnitOfWork: IUnitOfWork, IDisposable, Kipon.Xrm.IService
	{
		...
		public Kipon.Xrm.IRepository<kipon_vetest> Vetests
		{
			get
			{
				if (_vetests == null)
					{
						_vetests = new CrmRepository<kipon_vetest>(this.context, this._service);
					}
				return _vetests;
			}
		}
   ...
   public class CrmRepository<T> : Kipon.Xrm.IRepository<T> where T: Microsoft.Xrm.Sdk.Entity, new() 
	...
	[System.CodeDom.Compiler.GeneratedCodeAttribute("Kipon.Solid.Plugin", "1.0.10.14")]
