// Plugin Version: 1.0.9.1, Dynamics 365 svcutil solid extension tool by Kipon ApS (c) 2019,2020,2021, Kjeld Poulsen
...
namespace Kipon.Xrm
{
	...
	{
		public const string No = "1.0.9.1";
	}
}
namespace Kipon.Solid.Plugin.Entities
{
   ...
   public class CrmRepository<T> : Kipon.Xrm.IRepository<T> where T: Microsoft.Xrm.Sdk.Entity, new() 
	...
	[System.CodeDom.Compiler.GeneratedCodeAttribute("Kipon.Solid.Plugin", "1.0.9.1")]
