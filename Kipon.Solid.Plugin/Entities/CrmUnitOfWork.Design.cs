// Plugin Version: 1.0.10.20, Dynamics 365 svcutil solid extension tool by Kipon ApS (c) 2019,2020,2021,2022,2023. By Kjeld I. Poulsen
...
namespace Kipon.Xrm
{
	...
	{
		public const string No = "1.0.10.20";
	}
}
namespace Kipon.Solid.Plugin.Entities
{
   ...
   public class CrmRepository<T> : Kipon.Xrm.IRepository<T> where T: Microsoft.Xrm.Sdk.Entity, new() 
	...
	[System.CodeDom.Compiler.GeneratedCodeAttribute("Kipon.Solid.Plugin", "1.0.10.20")]
...
namespace Kipon.Solid.Plugin.Actions
{
	...
	[Kipon.Xrm.Attributes.LogicalName("quote")]
	public partial interface IGenerateQuoteFromOpportunityRequest: Kipon.Xrm.ActionTarget<Kipon.Solid.Plugin.Entities.Quote>
	{
		object OpportunityId { get; }
...
namespace Kipon.Solid.Plugin.Actions.Implement
{
	...
	public partial class GenerateQuoteFromOpportunityRequest : AbstractActionRequest, IGenerateQuoteFromOpportunityRequest
	{
		...
		public object OpportunityId {get => this.ValueOf<object>("OpportunityId");}
