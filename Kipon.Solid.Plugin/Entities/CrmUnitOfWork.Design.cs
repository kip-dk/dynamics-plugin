// Plugin Version: 1.0.1.4, Dynamics 365 svcutil solid extension tool by Kipon ApS (c) 2019, Kjeld Poulsen
...
namespace Kipon.Xrm
{
	...
	{
		public const string No = "1.0.1.4";
	}
}
...
{
	public interface IAccountCountContactsRequest: Kipon.Xrm.ActionTarget<Kipon.Solid.Plugin.Entities.Account>
	{
		string Name { get; }
	}
