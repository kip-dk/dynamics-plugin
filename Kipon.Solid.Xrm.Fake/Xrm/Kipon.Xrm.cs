/*
 * Kipon.Xrm.Tools version 1.0.2.0, Kipon.Xrm for SOLID plugins. © Kipon ApS, 2019, 2020.
 * 
    ...
    public class PluginMethod
    {
        public class Cache
        {
            ...
            private bool IsKnownMessage(string message)
            {
                ...
                if (message.StartsWith("OnValidate")) return true;
                if (message.StartsWith("OnPre")) return true;
                if (message.StartsWith("OnPost")) return true;
