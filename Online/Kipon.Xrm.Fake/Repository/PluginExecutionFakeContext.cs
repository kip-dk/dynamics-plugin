...
namespace Kipon.Xrm.Fake.Repository
{
    public class PluginExecutionFakeContext : System.IDisposable, IEntityShadow
    {
        ...
        {
            this.userId = userId;
            this.pluginMethodCache = new Kipon.Xrm.Reflection.PluginMethod.Cache(pluginType.Assembly);
        ...
        private Microsoft.Xrm.Sdk.Entity ResolveImage(string logicalName, Guid id, int pre1post2, Kipon.Xrm.Reflection.PluginMethod[] methods, EntityShadow pre)
        {
        ...
        private void ExecuteStep(Microsoft.Xrm.Sdk.Entity target, int stage, string message, bool isAsync, Action finalize, Action onDone)
        {
            ...
            if (methods.Length > 0)
            {
                ...
                if (message != "Create")
                {
                    ...
                    if (imagePre != null)
                    {
                        var imgName = Kipon.Xrm.Reflection.PluginMethod.ImageSuffixFor(1, stage, isAsync);
                ...
                if (stage == 40 && message != "Delete")
                {
                    ...
                    if (imagePost != null)
                    {
                        var imgName = Kipon.Xrm.Reflection.PluginMethod.ImageSuffixFor(2, stage, isAsync);
