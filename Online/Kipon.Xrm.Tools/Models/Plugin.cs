...
namespace Kipon.Xrm.Tools.Models
{
    public class Plugin
    {
        ...
        internal void AddStep(int stage, string message, string logicalname, bool isAsync, Kipon.Xrm.Reflection.PluginMethod[] methods)
        {
    ...
    {
        public static string[] FilteringAttributes(this Kipon.Xrm.Reflection.PluginMethod[] methods)
        {
        ...
        public static Image Preimage(this Kipon.Xrm.Reflection.PluginMethod[] methods)
        {
        ...
        public static Image Postimage(this Kipon.Xrm.Reflection.PluginMethod[] methods)
        {
