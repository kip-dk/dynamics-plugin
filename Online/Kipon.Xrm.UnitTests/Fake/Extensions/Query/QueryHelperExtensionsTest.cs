...
namespace Kipon.Xrm.UnitTests.Fake.Extensions.Query
{
    [TestClass]
    public class QueryHelperExtensionsTest : BaseTest
    {
        ...
        {
            {
                var ent1 = new Microsoft.Xrm.Sdk.EntityReference(Kipon.Online.Plugin.Entities.Account.EntityLogicalName, Guid.NewGuid());
                var ent2 = new Microsoft.Xrm.Sdk.EntityReference(Kipon.Online.Plugin.Entities.Account.EntityLogicalName, ent1.Id);
            ...
            {
                var value = new Microsoft.Xrm.Sdk.EntityReference(Kipon.Online.Plugin.Entities.Contact.EntityLogicalName, Guid.NewGuid());
            ...
            {
                var value = new Microsoft.Xrm.Sdk.EntityReference(Kipon.Online.Plugin.Entities.Contact.EntityLogicalName, Guid.NewGuid());
                var v2 = new Microsoft.Xrm.Sdk.EntityReference(Kipon.Online.Plugin.Entities.Contact.EntityLogicalName, value.Id);
            ...
            {
                var value = new Microsoft.Xrm.Sdk.EntityReference(Kipon.Online.Plugin.Entities.Contact.EntityLogicalName, Guid.NewGuid());
                var v2 = new Microsoft.Xrm.Sdk.EntityReference(Kipon.Online.Plugin.Entities.Account.EntityLogicalName, value.Id);
                var filter = new Microsoft.Xrm.Sdk.Query.ConditionExpression("value", Microsoft.Xrm.Sdk.Query.ConditionOperator.Equal, v2);
