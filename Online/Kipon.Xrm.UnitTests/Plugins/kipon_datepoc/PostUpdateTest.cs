...
namespace Kipon.Online.Plugin.UnitTests.Plugins.kipon_datepoc
{
    [TestClass]
    public class PostUpdateTest
    {
        ...
        {
            using (var ctx = Kipon.Xrm.Fake.Repository.PluginExecutionFakeContext.ForType<Kipon.Online.Plugin.Plugins.kipon_datepoc.kipon_datepocPlugin>())
            {
