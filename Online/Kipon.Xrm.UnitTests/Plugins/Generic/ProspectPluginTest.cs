...
namespace Kipon.Online.Plugin.UnitTests.Plugins.Generic
{
    [TestClass]
    public class ProspectPluginTest : BaseTest
    {
        ...
        {
            using (var ctx = Kipon.Xrm.Fake.Repository.PluginExecutionFakeContext.ForType<Kipon.Online.Plugin.Plugins.Generic.ProspectPlugin>())
            {
