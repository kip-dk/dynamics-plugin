namespace Kipon.Xrm.Extensions.Sdk
{
    ...
    {
        public static readonly Dictionary<string, Type> entittypes = new Dictionary<string, Type>();
        public static Dictionary<string, int> entityLogicalNameToTypeCodeIndex = new Dictionary<string, int>();
        public static Dictionary<int, string> typecodeToEntityLogicalNameIndex = new Dictionary<int, string>();
